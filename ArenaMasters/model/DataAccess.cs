...
namespace ArenaMasters.model
{
    class DataAccess
    {
        ...
        public string PA_GetItemSkillData(int id_character, int placement)
        {
            //int resultado = -99;
            DataSet ds = new DataSet();
            bool _target = false;
        ...
        public DataSet PA_GetAllShopItems(int id_game)
        {
            DataSet ds = new DataSet();
            int res = -99;
            try
            {
                ...
                _cmd.Connection = _conn;
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.CommandText = "getAllShopItems";
        ...
        public int PA_CountCharacters(int id_game)
        {
            int resultado = -99;
            try
            {
                ...
                _cmd.Connection = _conn;
                _cmd.CommandType = CommandType.StoredProcedure;
                _cmd.CommandText = "charactersNumber";
